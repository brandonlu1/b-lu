    ...
    <div className="home--container">
        ...
        <div className="home--projects">
            ...
            <div className="page--text--body">
                &emsp;&emsp;The Internship Initiative was a web application me and my friends made during the COVID-19 pandemic. The 
                ...
                By the end, we created and deployed the web application and marketed it towards high schools across New England. While over 50 schools expressed interest in the platform, it currently
                remains unused.
                <br/>
                <br/>
